...
var Q2 = class {
  ...
  getToken() {
    ...
    this.i !== t2 ? (C2("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e2 ? (M2("string" == typeof e2.accessToken), new q2(e2.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
...
function Ws(t2, e) {
  ...
  const i = function(t3) {
    if (0 === t3.length)
      return;
    const e2 = t3.map((t4) => // visible for testing
    function(t5) {
      if ("==" === t5.op) {
        if (pe(t5.value))
          return {
...
var _o = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.si = (t3) => Promise.resolve(), !_o.C())
...
!function(t2, e = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.7.2", t2), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
